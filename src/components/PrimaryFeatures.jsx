...
const features = [
  {
    ...
    description:
      'Tell us what you need delivered and where it\'s going.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'Get Quotes',
    description:
      'Get instant quotes, no hidden fees.',
  ...
  },
  {
    ...
    description:
      'Meet  your courier at open space and hand over the package to them.',
  ...
  },
  {
    ...
    description:
      'Get a notification when the package is delivered to the receiver and confirm on the app.',
    icon: DeviceTouchIcon,
    screen: InvestScreen,
  },
  {
    name: 'Secure Payment',
    description:
      'Our secure platform handles all transactions for peace of mind.',
    icon: DeviceTouchIcon,
    screen: InvestScreen,
  },
]
...
function FeaturesDesktop() {
  ...
  return (
    <TabGroup
      ...
      vertical
    >
      <TabList className="relative z-10 order-last col-span-6 space-y-2">
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          How We Work: Deliveries Made Simple From Diaspora (UK/Europe/USA/Canada) To Nigeria
          </h2>
